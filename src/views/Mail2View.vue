...
<template>
  <main>
    <div class="top">
      <router-link class="retour" to="/corbeil"><img src="@/assets/flecheB.svg">
        <p>Corbeil</p></router-link>
      <p>Modifier</p></div>
    <span></span>
    <div class="headMail">
      <div class="headImage"><img src="@/assets/profil.svg" alt="profil"></div>
      <div class="headEnTete"><h2>Nom de la personne</h2><p>à: pierre.legras@etudia... et 1 de plus ></p></div><div><p>hier</p></div>
    </div>
    <span></span>
    <div class="container">
      <h1>intitulé de l'email</h1>
